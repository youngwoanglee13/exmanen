...
form.addEventListener("submit", (event)=>{
    ...
    if ((0, _sumadorDefault.default)(first.value) != "error-publicacion") {
        div2.innerHTML = "";
        div.innerHTML = div.innerHTML + "<p>" + (0, _sumadorDefault.default)(first.value) + "</p>";
    } else div2.innerHTML = "<p>No se puede ingresar un post sin texto</p>";
});

},{"./sumador":"4OhmF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4OhmF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function publicar(mensaje) {
    if (mensaje.length == 0) return "error-publicacion";
    return mensaje;
}
exports.default = publicar;
